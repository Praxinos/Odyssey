...
public:
    ...
    virtual FMatrix CalcViewRotationMatrixForControllingActorView(const FRotator& InViewRotation) const override { return CalcViewRotationMatrix( InViewRotation ); };

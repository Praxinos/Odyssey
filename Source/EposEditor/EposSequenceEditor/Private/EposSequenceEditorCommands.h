...
public:
    ...
    TSharedPtr<FUICommandInfo> CreateAnimationCutAtCurrentTime;
    TSharedPtr<FUICommandInfo> GotoPreviousAnimationCut;
    TSharedPtr<FUICommandInfo> GotoNextAnimationCut;

...
public class EposPattern : ModuleRules
{
    public EposPattern(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        */
        ...
        {
            throw new InvalidOperationException("ERROR in EposPattern Module : Target.Type == TargetType.Game");
        }

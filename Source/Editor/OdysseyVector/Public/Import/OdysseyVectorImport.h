...
namespace FOdysseyVectorImport
{
    ...
    void ODYSSEYVECTOR_API Read( UOdysseyVectorRoot* iScene, FArchive &Ar );
    ...
    void ODYSSEYVECTOR_API ReadObjectEllipse( UOdysseyVectorCircle& iCircle, uint64 iChunkEnd, FArchive &Ar );
}

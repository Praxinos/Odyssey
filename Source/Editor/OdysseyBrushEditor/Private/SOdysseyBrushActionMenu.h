...
class SOdysseyBrushContextTargetMenu;
...
class SOdysseyBrushActionMenu : public SBorder
{
public:
    /** Delegate for the OnCloseReason event which is always raised when the SOdysseyBrushActionMenu closes */
    DECLARE_DELEGATE_ThreeParams( FClosedReason, bool /*bActionExecuted*/, bool /*bContextSensitiveChecked*/, bool /*bGraphPinContext*/);

    SLATE_BEGIN_ARGS( SOdysseyBrushActionMenu )
    ...
    void Construct( const FArguments& InArgs, TSharedPtr<FOdysseyBrushEditor> InEditor );
...
private:
    ...
    TSharedPtr<SOdysseyBrushContextTargetMenu> ContextTargetSubMenu;
...
class SOdysseyBrushActionMenuExpander : public SExpanderArrow
{
    SLATE_BEGIN_ARGS( SOdysseyBrushActionMenuExpander ) {}

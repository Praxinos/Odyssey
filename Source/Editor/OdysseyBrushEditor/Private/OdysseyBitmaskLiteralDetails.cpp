...
#define LOCTEXT_NAMESPACE "OdysseyBitmaskLiteralDetails"
...
void FBitmaskLiteralDetails::OnBitmaskEnumTypeChanged(TSharedPtr<FString> ItemSelected, ESelectInfo::Type SelectInfo)
{
    ...
    {
        if (const UEdGraphSchema_OdysseyBrush* K2Schema = Cast<UEdGraphSchema_OdysseyBrush>(InputPin->GetSchema()))
        {

...
public:
    ...
    TSharedRef<SWidget> GeneratePreviewMenu() const
    {
        ...
        {
            PreviewOptionsMenuBuilder.BeginSection("OdysseyBrushEditorPreviewOptions", NSLOCTEXT("OdysseyBrushEditor", "PreviewOptionsMenuHeader", "Preview Viewport Options"));
            {
                PreviewOptionsMenuBuilder.AddMenuEntry(FOdysseyBrushEditorCommands::Get().ResetCamera);
                PreviewOptionsMenuBuilder.AddMenuEntry(FEditorViewportCommands::Get().ToggleRealTime);
                PreviewOptionsMenuBuilder.AddMenuEntry(FOdysseyBrushEditorCommands::Get().ShowFloor);
                PreviewOptionsMenuBuilder.AddMenuEntry(FOdysseyBrushEditorCommands::Get().ShowGrid);
            }
    ...
    {
        FText Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Default", "Camera");
        ...
        if(EditorViewport.IsValid())
        {
            ...
            case LVT_Perspective:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Perspective", "Perspective");
                break;

            case LVT_OrthoXY:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Top", "Top");
                break;

            case LVT_OrthoYZ:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Left", "Left");
                break;

            case LVT_OrthoXZ:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Front", "Front");
                break;

            case LVT_OrthoNegativeXY:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Bottom", "Bottom");
                break;

            case LVT_OrthoNegativeYZ:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Right", "Right");
                break;

            case LVT_OrthoNegativeXZ:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_Back", "Back");
                break;

            case LVT_OrthoFreelook:
                Label = NSLOCTEXT("OdysseyBrushEditor", "CameraMenuTitle_OrthoFreelook", "Ortho");
                break;
            }
        }
    ...
    TSharedRef<SWidget> GenerateCameraMenu() const
    {
        ...
        CameraMenuBuilder.BeginSection("LevelViewportCameraType_Ortho", NSLOCTEXT("OdysseyBrushEditor", "CameraTypeHeader_Ortho", "Orthographic"));
    ...
    {
        FText Label = NSLOCTEXT("OdysseyBrushEditor", "ViewMenuTitle_Default", "View");
        ...
        if (EditorViewport.IsValid())
        {
            ...
            {
            case VMI_Lit:
                Label = NSLOCTEXT("OdysseyBrushEditor", "ViewMenuTitle_Lit", "Lit");
                break;

            case VMI_Unlit:
                Label = NSLOCTEXT("OdysseyBrushEditor", "ViewMenuTitle_Unlit", "Unlit");
                break;

            case VMI_BrushWireframe:
                Label = NSLOCTEXT("OdysseyBrushEditor", "ViewMenuTitle_Wireframe", "Wireframe");
                break;
            }
        }
    ...
    TSharedRef<SWidget> GenerateViewMenu() const
    {
        ...
        ViewMenuBuilder.AddMenuEntry(FEditorViewportCommands::Get().LitMode, NAME_None, NSLOCTEXT("OdysseyBrushEditor", "LitModeMenuOption", "Lit"));
        ViewMenuBuilder.AddMenuEntry(FEditorViewportCommands::Get().UnlitMode, NAME_None, NSLOCTEXT("OdysseyBrushEditor", "UnlitModeMenuOption", "Unlit"));
        ViewMenuBuilder.AddMenuEntry(FEditorViewportCommands::Get().WireframeMode, NAME_None, NSLOCTEXT("OdysseyBrushEditor", "WireframeModeMenuOption", "Wireframe"));
...
void SSCSEditorViewport::Construct(const FArguments& InArgs)
{
    ...
    // Save off the OdysseyBrush editor reference, we'll need this later
    OdysseyBrushEditorPtr = InArgs._OdysseyBrushEditor;
...
{
    FPreviewScene* PreviewScene = OdysseyBrushEditorPtr.Pin()->GetPreviewScene();

    // Construct a new viewport client instance.
    ViewportClient = MakeShareable(new FSCSEditorViewportClient(OdysseyBrushEditorPtr, PreviewScene, SharedThis(this)));
...
void SSCSEditorViewport::BindCommands()
{
    ...
    TSharedPtr<SSCSEditor> SCSEditorWidgetPtr = OdysseyBrushEditor->GetSCSEditor();
    ...
    CommandList->Append(OdysseyBrushEditor->GetSCSEditor()->CommandList.ToSharedRef());
    CommandList->Append(OdysseyBrushEditor->GetToolkitCommands());
    SEditorViewport::BindCommands();

    const FOdysseyBrushEditorCommands& Commands = FOdysseyBrushEditorCommands::Get();

    OdysseyBrushEditorPtr.Pin()->GetToolkitCommands()->MapAction(
...
void SSCSEditorViewport::ToggleIsSimulateEnabled()
{
    ...
    if ( !ViewportClient->GetIsSimulateEnabled() )
    {
        ...
        {
            OdysseyBrushEditorPtr.Pin()->GetTabManager()->InvokeTab(FOdysseyBrushEditorTabs::SCSViewportID);
        }
    }

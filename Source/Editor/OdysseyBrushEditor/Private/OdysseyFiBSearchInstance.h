...
class FFindInOdysseyBrushExpressionEvaluator : public FTextFilterExpressionEvaluator
{
public:
    /** Construction and assignment */
    FFindInOdysseyBrushExpressionEvaluator(const ETextFilterExpressionEvaluatorMode InMode, FFiBSearchInstance* InSearchInstance)
...
public:
    /**
     * Starts a search query given a string and an imaginary OdysseyBrush
     *
     * @param InSearchString                The string to search using
     * @param InImaginaryOdysseyBrushRoot        The imaginary OdysseyBrush to search through
     * @return                                Search result shared pointer, can be used for display in the search results window
     */
    FSearchResult StartSearchQuery(const FString& InSearchString, FImaginaryFiBDataSharedPtr InImaginaryOdysseyBrushRoot);
     ...
     * @param InImaginaryOdysseyBrushRoot        The imaginary OdysseyBrush to search through
     */
    void MakeSearchQuery(const FString& InSearchString, FImaginaryFiBDataSharedPtr InImaginaryOdysseyBrushRoot);
    ...
    /** Helper function to return search results given an imaginary OdysseyBrush root */
    FSearchResult GetSearchResults(FImaginaryFiBDataSharedPtr InImaginaryOdysseyBrushRoot);
public:
    /** Current item being searched in the Imaginary OdysseyBrush. Must be declared as thread-safe because this is a shared object. */

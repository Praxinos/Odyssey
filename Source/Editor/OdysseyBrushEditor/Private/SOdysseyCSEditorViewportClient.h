...
public:
     ...
     * Constructor.
     *
     * @param InOdysseyBrushEditorPtr A weak reference to the OdysseyBrush Editor context.
     * @param InPreviewScene The preview scene to use.
     */
    FSCSEditorViewportClient(TWeakPtr<class FOdysseyBrushEditor>& InOdysseyBrushEditorPtr, FPreviewScene* InPreviewScene, const TSharedRef<SSCSEditorViewport>& InSCSEditorViewport);

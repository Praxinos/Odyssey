...
class ODYSSEYBRUSHEDITOR_API FKismetVariableDragDropAction : public FMyOdysseyBrushItemDragDropAction
{
public:
    DRAG_DROP_OPERATOR_TYPE(FKismetVariableDragDropAction, FMyOdysseyBrushItemDragDropAction)

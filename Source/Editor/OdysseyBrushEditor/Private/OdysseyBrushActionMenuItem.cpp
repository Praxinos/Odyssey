...
#define LOCTEXT_NAMESPACE "OdysseyBrushActionMenuItem"

/*******************************************************************************
 * Static FOdysseyBrushMenuActionItem Helpers
 ******************************************************************************/

namespace FOdysseyBrushMenuActionItemImpl
{
    /**
     ...
     */
    static void DirtyOdysseyBrushFromNewNode(UEdGraphNode* SpawnedNode);
...
//------------------------------------------------------------------------------
static void FOdysseyBrushMenuActionItemImpl::DirtyOdysseyBrushFromNewNode(UEdGraphNode* SpawnedNode)
{
    UEdGraph const* const NodeGraph = SpawnedNode->GetGraph();
    check(NodeGraph != nullptr);

    UBlueprint* OdysseyBrush = FBlueprintEditorUtils::FindBlueprintForGraphChecked(NodeGraph);
...
//------------------------------------------------------------------------------
static UEdGraphNode* FOdysseyBrushMenuActionItemImpl::InvokeAction(const UBlueprintNodeSpawner* Action, UEdGraph* ParentGraph, FVector2D const Location, IBlueprintNodeBinder::FBindingSet const& Bindings, bool& bOutNewNode)
{
...
//------------------------------------------------------------------------------
static bool FOdysseyBrushMenuActionItemImpl::IsNodeLinked(UEdGraphPin* LeadingPin, UEdGraphNode& Node)
{
...
//------------------------------------------------------------------------------
static UEdGraphNode* FOdysseyBrushMenuActionItemImpl::AutowireSpawnedNodes(UEdGraphPin* FromPin, const TArray<UEdGraphNode*>& GraphNodes, int32 const NodesBeginIndex)
{
...
/*******************************************************************************
 * FOdysseyBrushMenuActionItem
 ******************************************************************************/

//------------------------------------------------------------------------------
FOdysseyBrushActionMenuItem::FOdysseyBrushActionMenuItem(UBlueprintNodeSpawner const* NodeSpawner, FBlueprintActionUiSpec const& UiSpec, IBlueprintNodeBinder::FBindingSet const& InBindings, FText InNodeCategory, int32 InGrouping)
...
//------------------------------------------------------------------------------
UEdGraphNode* FOdysseyBrushActionMenuItem::PerformAction(UEdGraph* ParentGraph, UEdGraphPin* FromPin, FVector2D const Location, bool bSelectNewNode/* = true*/)
{
    using namespace FOdysseyBrushMenuActionItemImpl;
    ...
    do
    {
        ...
        if (FromPin != nullptr)
        {
            ...
            FOdysseyBrushMenuActionItemImpl::AutowireSpawnedNodes(FromPin, ParentGraph->Nodes, PreInvokeNodeCount);
        }

        if (bNewNode)
        {
            DirtyOdysseyBrushFromNewNode(LastSpawnedNode);
        }

        // Increase the node location a safe distance so follow-up nodes are not stacked
        ModifiedLocation.Y += UEdGraphSchema_OdysseyBrush::EstimateNodeHeight(LastSpawnedNode);
...
//------------------------------------------------------------------------------
UEdGraphNode* FOdysseyBrushActionMenuItem::PerformAction(UEdGraph* ParentGraph, TArray<UEdGraphPin*>& FromPins, FVector2D const Location, bool bSelectNewNode/* = true*/)
{
...
//------------------------------------------------------------------------------
void FOdysseyBrushActionMenuItem::AddReferencedObjects(FReferenceCollector& Collector)
{
...
//------------------------------------------------------------------------------
void FOdysseyBrushActionMenuItem::AppendBindings(const FBlueprintActionContext& Context, IBlueprintNodeBinder::FBindingSet const& BindingSet)
{
...
//------------------------------------------------------------------------------
FSlateBrush const* FOdysseyBrushActionMenuItem::GetMenuIcon(FSlateColor& ColorOut)
{
    ColorOut = IconTint;
    return IconBrush;
}
...
//------------------------------------------------------------------------------
const FOdysseyBrushActionMenuItem::FDocExcerptRef& FOdysseyBrushActionMenuItem::GetDocumentationExcerpt() const
{
    return DocExcerptRef;
}

//------------------------------------------------------------------------------
bool FOdysseyBrushActionMenuItem::FDocExcerptRef::IsValid() const
{
    if (DocLink.IsEmpty())
    {
        return false;
...
//------------------------------------------------------------------------------
UBlueprintNodeSpawner const* FOdysseyBrushActionMenuItem::GetRawAction() const
{
    return Action;
}

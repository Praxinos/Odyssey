...
protected:
    /** Owning Kismet 2 */
    TWeakPtr<FOdysseyBrushEditor> Kismet2Ptr;
    ...
    bool bShowOdysseyBrushTitle;

    /** OdysseyBrush title being displayed for toolbar */
    FText OdysseyBrushTitle;
...
protected:
    ...
    /** Helper methods */
    EVisibility IsGraphOdysseyBrushNameVisible() const;

...
class ODYSSEYBRUSHEDITOR_API FKismetDelegateDragDropAction : public FKismetVariableDragDropAction
{
public:
    DRAG_DROP_OPERATOR_TYPE(FKismetDelegateDragDropAction, FKismetVariableDragDropAction)

    // FGraphEditorDragDropAction interface
    virtual void HoverTargetChanged() override { FMyOdysseyBrushItemDragDropAction::HoverTargetChanged(); }

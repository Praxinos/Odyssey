...
#define LOCTEXT_NAMESPACE "OdysseyUserDefinedStructureEditor"
...
public:
    FUserDefinedStructureLayout(TWeakPtr<class FUserDefinedStructureDetails> InStructureDetails)
        ...
        , InitialPinType(UEdGraphSchema_OdysseyBrush::PC_Boolean, NAME_None, nullptr, EPinContainerType::None, false, FEdGraphTerminalType())
    {}
...
public:
    ...
    void RemoveInvalidSubTypes(TSharedPtr<UEdGraphSchema_OdysseyBrush::FPinTypeTreeInfo> PinTypeNode, const UUserDefinedStruct* Parent) const
    {
    ...
    void GetFilteredVariableTypeTree( TArray< TSharedPtr<UEdGraphSchema_OdysseyBrush::FPinTypeTreeInfo> >& TypeTree, ETypeTreeFilter TypeTreeFilter) const
    {
        auto K2Schema = GetDefault<UEdGraphSchema_OdysseyBrush>();
        auto StructureDetailsSP = StructureDetails.Pin();
    ...
    virtual void GenerateChildContent( IDetailChildrenBuilder& ChildrenBuilder ) override
    {
        ...
        [
            SNew(SCheckBox)
            .ToolTipText(LOCTEXT("EditableOnBPInstance", "Variable can be edited on an instance of a OdysseyBrush."))

...
const UObject* DiffUtils::GetCDO(const UBlueprint* ForOdysseyBrush)
{
    if (!ForOdysseyBrush
        || !ForOdysseyBrush->GeneratedClass)
    {
        return NULL;
    }

    return ForOdysseyBrush->GeneratedClass->ClassDefaultObject;
}
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::NoDifferencesEntry()
{
    ...
    const auto GenerateWidget = []() -> TSharedRef<SWidget>
    {
        return SNew(STextBlock)
            ...
            .TextStyle(FEditorStyle::Get(), TEXT("OdysseyBrushDif.ItalicText"))
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "NoDifferencesLabel", "No differences detected..."));
    };

    return TSharedPtr<FOdysseyBrushDifferenceTreeEntry>(new FOdysseyBrushDifferenceTreeEntry(
        FOnDiffEntryFocused()
        , FGenerateDiffEntryWidget::CreateStatic(GenerateWidget)
        , TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >()
    ) );
}

TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::AnimBlueprintEntry()
{
    ...
    const auto GenerateWidget = []() -> TSharedRef<SWidget>
    {
        return SNew(STextBlock)
            .ColorAndOpacity(FLinearColor(.7f, .7f, .7f))
            .TextStyle(FEditorStyle::Get(), TEXT("OdysseyBrushDif.ItalicText"))
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "AnimBlueprintesNotSupported", "Warning: Detecting differences in Animation OdysseyBrush specific data is not yet supported..."));
    };

    TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> > Children;
    Children.Emplace( TSharedPtr<FOdysseyBrushDifferenceTreeEntry>(new FOdysseyBrushDifferenceTreeEntry(
        FOnDiffEntryFocused()
        , FGenerateDiffEntryWidget::CreateStatic(GenerateWidget)
        , TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >()
        )) );
    ...
    {
        return SNew(STextBlock)
            .ToolTipText(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "AnimGraphTooltip", "Detecting differences in Animation OdysseyBrush specific data is not yet supported"))
            .ColorAndOpacity(DiffViewUtils::LookupColor(true))
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "AnimGraphLabel", "Animation OdysseyBrush"));
    };
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::WidGetBlueprintEntry()
{
    ...
    const auto GenerateWidget = []() -> TSharedRef<SWidget>
    {
        return SNew(STextBlock)
            .ColorAndOpacity(FLinearColor(.7f, .7f, .7f))
            .TextStyle(FEditorStyle::Get(), TEXT("OdysseyBrushDif.ItalicText"))
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "WidgetTreeNotSupported", "Warning: Detecting differences in Widget OdysseyBrush specific data is not yet supported..."));
    };
    ...
    {
        return SNew(STextBlock)
            .ToolTipText(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "WidgetTreeTooltip", "Detecting differences in Widget OdysseyBrush specific data is not yet supported"))
            .ColorAndOpacity(DiffViewUtils::LookupColor(true))
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "WidgetTreeLabel", "Widget OdysseyBrush"));
    };
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::CreateDefaultsCategoryEntry(FOnDiffEntryFocused FocusCallback, const TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >& Children, bool bHasDifferences)
{
    const auto CreateDefaultsRootEntry = [](FLinearColor Color) -> TSharedRef<SWidget>
    {
        return SNew(STextBlock)
            .ToolTipText(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "DefaultsTooltip", "The list of changes made in the Defaults panel"))
            .ColorAndOpacity(Color)
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "DefaultsLabel", "Defaults"));
    };
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::CreateDefaultsCategoryEntryForMerge(FOnDiffEntryFocused FocusCallback, const TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >& Children, bool bHasRemoteDifferences, bool bHasLocalDifferences, bool bHasConflicts)
{
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::CreateComponentsCategoryEntry(FOnDiffEntryFocused FocusCallback, const TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >& Children, bool bHasDifferences)
{
    const auto CreateComponentsRootEntry = [](FLinearColor Color) -> TSharedRef<SWidget>
    {
        return SNew(STextBlock)
            .ToolTipText(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "SCSTooltip", "The list of changes made in the Components panel"))
            .ColorAndOpacity(Color)
            .Text(NSLOCTEXT("FOdysseyBrushDifferenceTreeEntry", "SCSLabel", "Components"));
    };
...
TSharedPtr<FOdysseyBrushDifferenceTreeEntry> FOdysseyBrushDifferenceTreeEntry::CreateComponentsCategoryEntryForMerge(FOnDiffEntryFocused FocusCallback, const TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >& Children, bool bHasRemoteDifferences, bool bHasLocalDifferences, bool bHasConflicts)
{
...
TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > DiffTreeView::CreateTreeView(TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >* DifferencesList)
{
    const auto RowGenerator = [](TSharedPtr< FOdysseyBrushDifferenceTreeEntry > Entry, const TSharedRef<STableViewBase>& Owner) -> TSharedRef< ITableRow >
    {
        return SNew(STableRow<TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >, Owner)
            [
                Entry->GenerateWidget.Execute()
            ];
    };

    const auto ChildrenAccessor = [](TSharedPtr<FOdysseyBrushDifferenceTreeEntry> InTreeItem, TArray< TSharedPtr< FOdysseyBrushDifferenceTreeEntry > >& OutChildren, TArray< TSharedPtr<FOdysseyBrushDifferenceTreeEntry> >* MasterList)
    {
        OutChildren = InTreeItem->Children;
    };

    const auto Selector = [](TSharedPtr<FOdysseyBrushDifferenceTreeEntry> InTreeItem, ESelectInfo::Type Type)
    {
    ...
    return SNew(STreeView< TSharedPtr< FOdysseyBrushDifferenceTreeEntry > >)
        .OnGenerateRow(STreeView< TSharedPtr< FOdysseyBrushDifferenceTreeEntry > >::FOnGenerateRow::CreateStatic(RowGenerator))
        .OnGetChildren(STreeView< TSharedPtr< FOdysseyBrushDifferenceTreeEntry > >::FOnGetChildren::CreateStatic(ChildrenAccessor, DifferencesList))
        .OnSelectionChanged(STreeView< TSharedPtr< FOdysseyBrushDifferenceTreeEntry > >::FOnSelectionChanged::CreateStatic(Selector))
        .TreeItemsSource(DifferencesList);
}

int32 DiffTreeView::CurrentDifference(TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > TreeView, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& Differences)
{
...
void DiffTreeView::HighlightNextDifference(TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > TreeView, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& Differences, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& RootDifferences)
{
...
void DiffTreeView::HighlightPrevDifference(TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > TreeView, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& Differences, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& RootDifferences)
{
    int32 CurrentIndex = CurrentDifference(TreeView, Differences);
...
bool DiffTreeView::HasNextDifference(TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > TreeView, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& Differences)
{
    int32 CurrentIndex = CurrentDifference(TreeView, Differences);
    return Differences.IsValidIndex(CurrentIndex + 1);
}

bool DiffTreeView::HasPrevDifference(TSharedRef< STreeView<TSharedPtr< FOdysseyBrushDifferenceTreeEntry > > > TreeView, const TArray< TSharedPtr<class FOdysseyBrushDifferenceTreeEntry> >& Differences)
{
    int32 CurrentIndex = CurrentDifference(TreeView, Differences);
    return Differences.IsValidIndex(CurrentIndex - 1);
}
...
FText DiffViewUtils::GetPanelLabel(const UBlueprint* OdysseyBrush, const FRevisionInfo& Revision, FText Label )
{
    if( !Revision.Revision.IsEmpty() )
    {
        ...
        return FText::Format( NSLOCTEXT("DiffViewUtils", "RevisionLabel", "{0}\n{1}\n{2}")
            , Label
            , FText::FromString( OdysseyBrush->GetName() )
            , RevisionData );
    }
    else
    {
        ...
        return NSLOCTEXT("DiffViewUtils", "NoOdysseyBrush", "None" );
    }
}
...
SHorizontalBox::FSlot& DiffViewUtils::Box(bool bIsPresent, FLinearColor Color)
{
    return SHorizontalBox::Slot()
        ...
        [
            SNew(SImage)
            .ColorAndOpacity(Color)
            .Image(bIsPresent ? FEditorStyle::GetBrush("OdysseyBrushDif.HasGraph") : FEditorStyle::GetBrush("OdysseyBrushDif.MissingGraph"))
        ];
};

...
public:
    ...
    {
        return LOCTEXT("DefaultsEditorTooltip", "The class defaults editor lets you set the default value for all variables in your OdysseyBrush.");
    }

private:
    TSharedRef<SWidget> CreateOptionalDataOnlyMessage() const;

    void OnChangeOdysseyBrushToNotDataOnly();
};
...
public:
    FGraphEditorSummoner(TSharedPtr<class FOdysseyBrushEditor> InOdysseyBrushEditorPtr, FOnCreateGraphEditorWidget CreateGraphEditorWidgetCallback);
...
protected:
    TWeakPtr<class FOdysseyBrushEditor> OdysseyBrushEditorPtr;
...
{
public:
    FTimelineEditorSummoner(TSharedPtr<class FOdysseyBrushEditor> InOdysseyBrushEditorPtr);
protected:
...
//     {
//         OdysseyBrushEditorPtr.Pin()->RequestSaveEditedObjectState();
//     }
    ...
    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("TimelineEditorTooltip", "The Timeline editor lets you add tracks and visually keyframe values over time, to be used inside a OdysseyBrush graph.");
    }
...
public:
    ...
    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("ComponentsTabTooltip", "The Components tab is for easily adding, selecting and attaching Components within your OdysseyBrush.");
    }
};
...
public:
    ...
    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("BookmarksTooltip", "The Bookmarks tab allows you to create, edit and select bookmarks associated with this OdysseyBrush.");
    }
};

/////////////////////////////////////////////////////
// FMyOdysseyBrushSummoner

struct FMyOdysseyBrushSummoner : public FWorkflowTabFactory
{
public:
    FMyOdysseyBrushSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

    virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("MyOdysseyBrushTooltip", "The MyOdysseyBrush tab shows you elements that belong to _this_ OdysseyBrush (variables, graphs etc.)");
    }
};
...
public:
    ...
    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("ReplaceNodeReferencesTooltip", "Allows the user to replace node references in all OdysseyBrush graphs with another node reference.");
    }
};
...
public:
    ...
    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("FindResultsTooltip", "The find results tab shows results of searching this OdysseyBrush (or all Blueprints).");
    }
};

//////////////////////////////////////////////////////////////////////////
// FOdysseyBrushPreviewSummoner

struct FOdysseyBrushPreviewSummoner : public FWorkflowTabFactory
{
public:
    FOdysseyBrushPreviewSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

    virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("OdysseyBrushPreviewTooltip", "Preview for OdysseyBrush");
    }
};

//////////////////////////////////////////////////////////////////////////
// FOdysseyBrushTestAreaSummoner

struct FOdysseyBrushTestAreaSummoner : public FWorkflowTabFactory
{
public:
    FOdysseyBrushTestAreaSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

    virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("OdysseyBrushTestAreaTooltip", "Test Area for OdysseyBrush");
    }
};


//////////////////////////////////////////////////////////////////////////
// FOdysseyBrushPreferencesOverridesSummoner
struct FOdysseyBrushPreferencesOverridesSummoner: public FWorkflowTabFactory
{
public:
    FOdysseyBrushPreferencesOverridesSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

    virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("OdysseyBrushPreferencesOverridesTooltip", "Preferences Overrides for OdysseyBrush");
    }
};

//////////////////////////////////////////////////////////////////////////
// FOdysseyBrushInternalExposedSummoner

struct FOdysseyBrushInternalExposedSummoner: public FWorkflowTabFactory
{
public:
    FOdysseyBrushInternalExposedSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

    virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

    virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
    {
        return LOCTEXT("OdysseyBrushInternalExposedTooltip", "Exposed Widget for OdysseyBrush");
    }
};

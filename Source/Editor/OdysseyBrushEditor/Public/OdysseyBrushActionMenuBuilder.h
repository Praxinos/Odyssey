 ...
 * FOdysseyBrushActionMenuItems for actions that pass. Takes care of generating the
 * each menu item's category/name/etc.
 */
struct ODYSSEYBRUSHEDITOR_API FOdysseyBrushActionMenuBuilder : public FGraphActionListBuilderBase
{
public:
...
public:
    FOdysseyBrushActionMenuBuilder(TWeakPtr<FOdysseyBrushEditor> OdysseyBrushEditorPtr);
     ...
     * multiple FOdysseyBrushActionMenuBuilders and append them together, but that
...
private:
     ...
     * this API clean).
     */
    TArray< TSharedRef<FOdysseyBrushActionMenuBuilderImpl::FMenuSectionDefinition> > MenuSections;

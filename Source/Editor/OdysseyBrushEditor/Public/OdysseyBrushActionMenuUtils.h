...
class UK2Node;
struct FOdysseyBrushActionMenuBuilder;

UENUM()
namespace EOdysseyContextTargetFlags
{
    enum Type
    {
        TARGET_OdysseyBrush            = 0x00000001 UMETA(DisplayName="This OdysseyBrush", ToolTip="Include functions and variables that belong to this OdysseyBrush."),
        TARGET_SubComponents        = 0x00000002 UMETA(DisplayName="Components", ToolTip="Include functions that belong to components of this OdysseyBrush and/or the other target classes."),
        ...
        TARGET_OdysseyBrushLibraries    = 0x00000020 UMETA(DisplayName="Libraries", ToolTip="Include static functions that are globally accessible (belonging to function/macro libraries, etc.)."),
...
struct FOdysseyBrushActionMenuUtils
{
    /**
     ...
     */
    ODYSSEYBRUSHEDITOR_API static void MakePaletteMenu(FBlueprintActionContext const& Context, UClass* FilterClass, FOdysseyBrushActionMenuBuilder& MenuOut);
     ...
     */
    ODYSSEYBRUSHEDITOR_API static void MakeContextMenu(FBlueprintActionContext const& Context, bool bIsContextSensitive, uint32 ClassTargetMask, FOdysseyBrushActionMenuBuilder& MenuOut);
     ...
     */
    ODYSSEYBRUSHEDITOR_API static void MakeFavoritesMenu(FBlueprintActionContext const& Context, FOdysseyBrushActionMenuBuilder& MenuOut);
     ...
     */
    ODYSSEYBRUSHEDITOR_API static const UK2Node* ExtractNodeTemplateFromAction(TSharedPtr<FEdGraphSchemaAction> PaletteAction);
};

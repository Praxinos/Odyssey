...
#include "OdysseyBrushDragDropMenuItem.generated.h"
 ...
 */
USTRUCT()
struct FOdysseyBrushDragDropMenuItem : public FEdGraphSchemaAction
{
    GENERATED_USTRUCT_BODY();

public:
    static FName StaticGetTypeId() { static FName const TypeId("FOdysseyBrushDragDropMenuItem"); return TypeId; }
    /** Default constructor for USTRUCT() purposes. */
    FOdysseyBrushDragDropMenuItem() {}
     ...
     */
    FOdysseyBrushDragDropMenuItem(FBlueprintActionContext const& Context, UBlueprintNodeSpawner const* SampleAction, int32 MenuGrouping, FText InNodeCategory, FText InMenuDesc, FText InToolTip );

...
class FImaginaryOdysseyBrush : public FImaginaryFiBData
{
public:
    FImaginaryOdysseyBrush(FString InOdysseyBrushName, FString InOdysseyBrushPath, FString InOdysseyBrushParentClass, TArray<FString>& InInterfaces, FString InUnparsedStringData, bool bInIsVersioned = true);
...
protected:
    /** The path for this OdysseyBrush */
    FString OdysseyBrushPath;

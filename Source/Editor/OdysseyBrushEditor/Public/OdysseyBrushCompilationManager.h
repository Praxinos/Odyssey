...
#include "CoreMinimal.h" // for DLLEXPORT (ODYSSEYBRUSHEDITOR_API)
...
struct ODYSSEYBRUSHEDITOR_API FOdysseyBrushCompilationManager
{
     ...
     */
    static void NotifyOdysseyBrushLoaded(UBlueprint* BPLoaded);
...
private:
    FOdysseyBrushCompilationManager();
};

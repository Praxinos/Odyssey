 ...
 */
class OdysseyImageLayerNode : public OdysseyBaseLayerNode
{
...
public:
    ...
    OdysseyImageLayerNode( FOdysseyImageLayer& InImageLayer, TSharedPtr<OdysseyBaseLayerNode> InParentNode, FOdysseyLayerStackTree& InParentTree );

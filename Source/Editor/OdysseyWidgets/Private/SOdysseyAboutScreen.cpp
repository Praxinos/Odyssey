...
SOdysseyAboutScreen::Construct( const FArguments& iArgs )
{
    ...
    mAboutLines.Add( MakeShareable( new FLineDefinition( LOCTEXT( "copyright.iddn", "IDDN.FR.001.250001.006.S.P.2019.000.00000" ), 8, FLinearColor( 1.f, 1.f, 1.f ), FMargin( 0.f, 2.f, 0.f, 12.f ) ) ) );

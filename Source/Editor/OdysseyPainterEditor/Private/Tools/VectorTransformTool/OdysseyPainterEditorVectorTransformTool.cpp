                                                           ...
                                                           , const FKey& iKey )
{
    ...
    if( iKey == EKeys::LeftMouseButton )
    {
        ...
        if( mEditor->GetVectorEditionFlags() & FOdysseyVectorHUD::VIEW_MODE_OBJECT )
        {
            ...
            mTransformHUD->GetAlteredObjectList( iScene, objectList );
                                                                  ...
                                                                  , const FOdysseyPoint& iPointInTexture )
{
    ...
    if( mEditor->GetVectorEditionFlags() & FOdysseyVectorHUD::VIEW_MODE_OBJECT )
    {
        ...
        mTransformHUD->Traverse( iScene
                            , iScene
                            , GetEditor()->GetVectorEditionFlags()
                            , [ &spaceMatrix
                              , &inverseSpaceMatrix
                              , &translateMatrix ](FOdysseyVectorObject* object) -> bool
                              {
                                  double translationX;
                                  double translationY;
                                  double rotation;
                                                               ...
                                                               , const FOdysseyPoint& iPointInTexture )
{
    ...
    if( mEditor->GetVectorEditionFlags() & FOdysseyVectorHUD::VIEW_MODE_OBJECT )
    {
        ...
        mTransformHUD->Traverse( iScene
                            ...
                            , [ &spaceMatrix
                              , &inverseSpaceMatrix
                              , &rotateMatrix](FOdysseyVectorObject* object) -> bool
                              {
                                  double translationX;
                                  double translationY;
                                  double rotation;
    ...
    //if( ( hudFlags & FOdysseyPainterEditorVectorObjectScaleToolHUD::HANDLE_MASK ) != 0 )
    {
        ...
        if( mEditor->GetVectorEditionFlags() & FOdysseyVectorHUD::VIEW_MODE_OBJECT )
        {
            ...
            mTransformHUD->Traverse( iScene
                                ...
                                , [ &spaceMatrix
                                  , &inverseSpaceMatrix
                                  , &scalingMatrix](FOdysseyVectorObject* object) -> bool
                                  {
                                      double translationX;
                                      double translationY;
                                      double rotation;

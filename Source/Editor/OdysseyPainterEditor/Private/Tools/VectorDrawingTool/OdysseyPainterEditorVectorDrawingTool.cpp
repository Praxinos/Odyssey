...
UOdysseyPainterEditorVectorDrawingTool::~UOdysseyPainterEditorVectorDrawingTool()
{
}
...
bool
UOdysseyPainterEditorVectorDrawingTool::CanDraw()
{
    return IsActivable();
}

bool
UOdysseyPainterEditorVectorDrawingTool::OnMouseDown(const FOdysseyPoint& iPointInTexture, const FKey& iKey)
{
...
void
UOdysseyPainterEditorVectorDrawingTool::OnMouseDrag(const FOdysseyPoint& iPointInTexture)
{
    UOdysseyTextureLayerStack* layerStack = Cast<UOdysseyTextureLayerStack>(GetEditorAs<FOdysseyTextureEditor>()->LayerStack());
    UOdysseyTextureLayerImageVector* currentVectorLayer = GetCurrentVectorImageLayer();
...
bool
UOdysseyPainterEditorVectorDrawingTool::OnMouseUp(const FOdysseyPoint& iPointInTexture, const FKey& iKey)
{
    UOdysseyTextureLayerStack* layerStack = Cast<UOdysseyTextureLayerStack>(GetEditorAs<FOdysseyTextureEditor>()->LayerStack());
    UOdysseyTextureLayerImageVector* currentVectorLayer = GetCurrentVectorImageLayer();
...
void
UOdysseyPainterEditorVectorDrawingTool::Commit()
{

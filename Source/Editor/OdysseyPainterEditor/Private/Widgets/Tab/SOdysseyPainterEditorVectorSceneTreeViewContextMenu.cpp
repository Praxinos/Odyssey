...
SOdysseyPainterEditorVectorSceneTreeViewContextMenu::CreateWidget( SOdysseyPainterEditorVectorSceneTreeView* iTreeView )
{
    ...
    menu.AddMenuEntry(
        ...
        , LOCTEXT("Copy", "Copy")
        , FSlateIcon("OdysseyStyle", "OdysseyLogo.Iliad16")
        , FUIAction(FExecuteAction::CreateStatic(&FOdysseyPainterEditor::CopyObjectSelection, vectorScene)));
    menu.AddMenuEntry(
          LOCTEXT("Paste", "Paste")
        , LOCTEXT("Paste", "Paste")
        , FSlateIcon("OdysseyStyle", "OdysseyLogo.Iliad16")
        , FUIAction(FExecuteAction::CreateStatic(&FOdysseyPainterEditor::PasteObjectSelection, vectorScene)));
    menu.AddMenuEntry(

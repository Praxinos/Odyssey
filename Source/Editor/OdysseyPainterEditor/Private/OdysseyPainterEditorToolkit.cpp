...
//----------------------------------------------------------------------- Initialization
void
FOdysseyPainterEditorToolkit::InitPainterEditorToolkit( const FName& iAppIdentifier, TArray<UObject*>& iObjectsToEdit )
{
    FAssetEditorToolkit::InitAssetEditor( EToolkitMode::Standalone, NULL, iAppIdentifier, GetLayout(), true, false, iObjectsToEdit);
    InitializeExtenders();

...
SOdysseyViewportDrawingEditorGUI::SOdysseyViewportDrawingEditorGUI()
    : mSelectedView (EOdysseyViewportView::kBrushSettings)
{
}
...
{
    if( mSelectedView == EOdysseyViewportView::kBrushSettings )
...
{
    if( mSelectedView == EOdysseyViewportView::kLayerStack )
        return EVisibility::Visible;
    else
	    return EVisibility::Collapsed;
}
...
{
    if( mSelectedView == EOdysseyViewportView::kStrokeOptions )
        return EVisibility::Visible;
    else
	    return EVisibility::Collapsed;
}
...
{
    if( mSelectedView == EOdysseyViewportView::kTools )
        return EVisibility::Visible;
    else
        return EVisibility::Collapsed;
}
...
{
    mSelectedView = EOdysseyViewportView::kStrokeOptions;
}

void
SOdysseyViewportDrawingEditorGUI::OnSetOdysseyLayerStackView()
{
    mSelectedView = EOdysseyViewportView::kLayerStack;
}

void
SOdysseyViewportDrawingEditorGUI::OnSetOdysseyToolsView()
{
    mSelectedView = EOdysseyViewportView::kTools;
}

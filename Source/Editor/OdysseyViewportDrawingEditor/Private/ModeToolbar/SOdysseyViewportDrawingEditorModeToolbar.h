...
#include "Mesh/FOdysseyViewportDrawingEditorModeToolbar.h"
 ...
 */
class ODYSSEYWIDGETS_API SOdysseyViewportDrawingEditorModeToolbar : public SCompoundWidget
{
public:
    SLATE_BEGIN_ARGS(SOdysseyViewportDrawingEditorModeToolbar)
        {}
...
public:
    // Getter / Setter
    FOdysseyViewportDrawingEditorModeToolbar* GetMeshSelectorPtr();
...
private:
    // Private data
    TSharedPtr< FOdysseyViewportDrawingEditorModeToolbar > MeshSelector;

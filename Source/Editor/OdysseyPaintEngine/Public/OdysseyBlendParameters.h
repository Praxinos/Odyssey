...
public:
    UPROPERTY(EditAnywhere, Category="Odyssey Blend Parameters")
    bool bEraserMode;

    UPROPERTY( EditAnywhere, Category="Odyssey Blend Parameters", meta = (EditCondition = "!bEraserMode"))
    EOdysseyBlendingMode BlendingMode;

    UPROPERTY( EditAnywhere, Category="Odyssey Blend Parameters", meta = (EditCondition = "!bEraserMode"))
    EOdysseyAlphaMode AlphaMode;

    UPROPERTY( EditAnywhere, Category="Odyssey Blend Parameters", meta = ( EditCondition="!bEraserMode", ClampMin = "0", ClampMax = "100", UIMin = "0", UIMax = "100", Delta = "1", Multiple = "1", Units = "Percent"))
    float Opacity;
};
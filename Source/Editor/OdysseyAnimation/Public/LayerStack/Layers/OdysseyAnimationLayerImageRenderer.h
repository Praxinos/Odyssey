...
{
public:
    FOdysseyAnimationLayerImageRenderer(UOdysseyAnimationLayer* iLayer, int iFrame, bool iThreadSafe);
...
public:
    TArray<TSharedPtr<IOdysseyImageRenderer>> mChildrenRenderers;
};

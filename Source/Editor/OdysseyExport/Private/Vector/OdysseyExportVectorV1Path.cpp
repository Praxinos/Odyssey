...
void
FOdysseyExportVectorV1::WritePathCubicGeometrySegments( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    if( iPath.GetSegmentList().size() )
    {
        FOdysseyExport::WriteChunk( FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY_CUBICSEGMENTS
                                        , Ar
...
void
FOdysseyExportVectorV1::WritePathCubicGeometryVertices( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    if ( iPath.GetVertexList().size() )
    {
        FOdysseyExport::WriteChunk( FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY_VERTICES
                                        , Ar
                                        , [&iPath](FArchive &Ar) -> void
        {
            uint32 vertexID = 0;
...
void
FOdysseyExportVectorV1::WritePathCubicGeometry( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY
                                    , Ar
                                    , [&iPath](FArchive &Ar) -> void
    {
...
void
FOdysseyExportVectorV1::WritePathJoint( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV1::CHUNK_PATH_JOINT
                                    , Ar
                                    , [&iPath](FArchive &Ar) -> void
    {
...
void
FOdysseyExportVectorV1::WritePath( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV1::CHUNK_OBJECT_PATH
                                    , Ar
                                    , [&iPath](FArchive &Ar) -> void
    {

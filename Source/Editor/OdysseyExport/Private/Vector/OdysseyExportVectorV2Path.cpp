...
//static
void
FOdysseyExportVectorV2::WritePathGeometrySegments( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    if( iPath.GetSegmentList().size() )
    {
        FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY_CUBICSEGMENTS
                                        , Ar
...
//static
void
FOdysseyExportVectorV2::WritePathGeometryVertexHandleAlignment( FOdysseyVectorVertex& iVertex, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY_VERTEX_HANDLEALIGNMENT
                                      , Ar
...
//static
void
FOdysseyExportVectorV2::WritePathGeometryVertexPosition( FOdysseyVectorVertex& iVertex, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY_VERTEX_POSITION
                                      , Ar
                                      , [&iVertex](FArchive &Ar) -> void
    {
...
//static
void
FOdysseyExportVectorV2::WritePathGeometryVertex( FOdysseyVectorVertex& iVertex, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY_VERTEX
                                      , Ar
                                      , [&iVertex](FArchive &Ar) -> void
    {
...
//static
void
FOdysseyExportVectorV2::WritePathGeometryVertices( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    if ( iPath.GetVertexList().size() )
    {
        FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY_VERTICES
                                        , Ar
                                        , [&iPath](FArchive &Ar) -> void
        {
            uint32 vertexID = 0;
...
//static
void
FOdysseyExportVectorV2::WritePathGeometry( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    uint32 vertexID = 0;
    ...
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_GEOMETRY
                                      , Ar
                                      , [&iPath](FArchive &Ar) -> void
    {
...
//static
void
FOdysseyExportVectorV2::WritePathJoint( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH_JOINT
                                    , Ar
                                    , [&iPath](FArchive &Ar) -> void
    {
...
//static
void
FOdysseyExportVectorV2::WritePath( FOdysseyVectorPath& iPath, FArchive &Ar )
{
    FOdysseyExport::WriteChunk( FOdysseyExportVectorV2::CHUNK_PATH
                                    , Ar
                                    , [&iPath](FArchive &Ar) -> void
    {
        // inherited chunks

...
// TODO: can be factorised with SOdysseyLayerExpanderArrow
 ...
 */
class ODYSSEYPALETTE_API SOdysseyPaletteExpanderArrow : public SCompoundWidget
{
    SLATE_DECLARE_WIDGET(SOdysseyPaletteExpanderArrow, SCompoundWidget)

public:
    SLATE_BEGIN_ARGS( SOdysseyPaletteExpanderArrow )
    ...
    SOdysseyPaletteExpanderArrow();

public:
    void Construct( const FArguments& InArgs, const TSharedPtr<class SOdysseyPaletteEntryRow>& iPaletteEntryRow );
...
private:
    TWeakPtr<class SOdysseyPaletteEntryRow> mPaletteRow;

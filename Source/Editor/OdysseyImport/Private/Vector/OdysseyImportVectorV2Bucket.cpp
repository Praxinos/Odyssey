...
void
FOdysseyImportVectorV2::ReadBucket( FOdysseyVectorBucket& iBucket, uint64 iChunkEnd, FArchive &Ar )
{
    FOdysseyImport::ReadChunks( iChunkEnd
                                    ...
                                    , [&iBucket](uint32 iChunkID, uint64 iChunkLen, FArchive &Ar) -> void
        {
            switch( iChunkID )
            {
                case FOdysseyExportVectorV2::CHUNK_BUCKET_COLORMODE:
                {
                    uint32 colorMode;
                ...
                case FOdysseyExportVectorV2::CHUNK_BUCKET_PALETTEENTRY:
                {
                    FName nameEntry;
                    Ar << nameEntry;
                ...
                case FOdysseyExportVectorV2::CHUNK_BUCKET_SPREADING:
                {
                ...
                case FOdysseyExportVectorV2::CHUNK_BUCKET_GRADIENT_RADIALRADIUS:
                {
                    double radialRadius;
                ...
                case FOdysseyExportVectorV2::CHUNK_BUCKET_GRADIENT_RADIALOFFSET:
                {
                    double offsetX;
                    double offsetY;

...
void
FOdysseyImportVectorV1::ReadBucket( FOdysseyVectorBucket& iBucket, uint64 iChunkEnd, FArchive &Ar )
{
    FOdysseyImport::ReadChunks( iChunkEnd
                                    ...
                                    , [&iBucket](uint32 iChunkID, uint64 iChunkLen, FArchive &Ar) -> void
        {
            switch( iChunkID )
            {
                case FOdysseyExportVectorV1::CHUNK_BUCKET_PALETTEENTRY:
                {
                    FName nameEntry;
                    Ar << nameEntry;
                ...
                case FOdysseyExportVectorV1::CHUNK_BUCKET_SPREADING:
                {

...
void
FOdysseyImportVectorV1::ReadPathGeometryCubicSegments( FOdysseyVectorPath& iPath
...
void
FOdysseyImportVectorV1::ReadPathGeometryVertices( FOdysseyVectorPath& iPath
                                                , std::vector<FOdysseyVectorVertex*>& vertexArray
                                                , FArchive &Ar )
{
    uint32 vertexCount;
...
void
FOdysseyImportVectorV1::ReadPath( FOdysseyVectorPath& iPath, uint64 iChunkEnd, FArchive &Ar )
{
    std::vector<FOdysseyVectorVertex*> vertexArray;
    ...
    FOdysseyImport::ReadChunks( iChunkEnd
                                    ...
                                    , [&iPath, &vertexArray](uint32 iChunkID, uint64 iChunkLen, FArchive &Ar) -> void
        {
            switch( iChunkID )
            {
                case FOdysseyExportVectorV1::CHUNK_PATH_JOINT:
                {
                    uint32 jointType;
                ...
                case FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY:
                break;

                case FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY_VERTICES:
                    ReadPathGeometryVertices( iPath, vertexArray, Ar );
                break;

                case FOdysseyExportVectorV1::CHUNK_PATH_GEOMETRY_CUBICSEGMENTS:

...
#include "OdysseyTextureEditorVectorRotateObjectTool.generated.h"

UCLASS()
class ODYSSEYTEXTUREEDITOR_API UOdysseyTextureEditorVectorRotateObjectTool : public UOdysseyPainterEditorVectorRotateObjectTool
{
    GENERATED_BODY()

public:
    // Destructor
    virtual ~UOdysseyTextureEditorVectorRotateObjectTool();

...
#include "OdysseyTextureEditorVectorMoveObjectTool.generated.h"

UCLASS()
class ODYSSEYTEXTUREEDITOR_API UOdysseyTextureEditorVectorMoveObjectTool : public UOdysseyPainterEditorVectorMoveObjectTool
{
    GENERATED_BODY()

public:
    // Destructor
    virtual ~UOdysseyTextureEditorVectorMoveObjectTool();

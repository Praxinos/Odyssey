...
ODYSSEYIMAGING_API void InvalidateSurfaceFromData(const FOdysseyBlock* iData,FOdysseySurfaceTexture2DEditable* iSurface);
ODYSSEYIMAGING_API void InvalidateSurfaceFromData(const FOdysseyBlock* iData,FOdysseySurfaceTexture2DEditable* iSurface,int iX1,int iY1,int iX2,int iY2);
...
ODYSSEYIMAGING_API void InvalidateSurfaceFromData(const ::ul3::FBlock* iData,FOdysseySurfaceTexture2DEditable* iSurface,const ::ul3::FRect& iRect);
...
public:
    ...
    FOdysseySurfaceTexture2DEditable(int iWidth,int iHeight, ::ul3::tFormat iFormat = ULIS3_FORMAT_BGRA8);

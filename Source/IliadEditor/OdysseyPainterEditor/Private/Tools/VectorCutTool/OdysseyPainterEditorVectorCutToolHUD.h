...
{
    public:
        virtual ~FOdysseyPainterEditorVectorCutToolHUD();
        FOdysseyPainterEditorVectorCutToolHUD(  UOdysseyPainterEditorVectorCutTool* iSelectionTool );
         ...
         */
        ::ULIS::FRectD GenerateFreehandMask( std::vector<::ULIS::FVec2D>& iPointArray, bool iStroke );
         ...
         */
        ::ULIS::FRectD GenerateCircleMask( double iX, double iY, double iRadius, bool iStroke );
         ...
         */
        ::ULIS::FRectD GenerateRectangleMask( const ::ULIS::FRectD& iRect, bool iStroke );
    ...
    protected:
        UOdysseyPainterEditorVectorCutTool* mCutTool;

...
void
FOdysseyPainterEditorVectorScenePanToolHUD::DrawFrame( const FOdysseyHUDElement::FDrawHUDParams& iParams
                                                     , ::ULIS::FRectI& iFrame
...
void
FOdysseyPainterEditorVectorScenePanToolHUD::DrawHUD( const FOdysseyHUDElement::FDrawHUDParams& iParams )
{

...
void
FOdysseyPainterEditorVectorTransformToolHUD::DrawScalers( const FOdysseyHUDElement::FDrawHUDParams& iParams )
{
...
void
FOdysseyPainterEditorVectorTransformToolHUD::DrawGizmo( const FOdysseyHUDElement::FDrawHUDParams& iParams )
{
    FLinearColor fgColor = FLinearColor( FOdysseyVectorHUD::GetForegroundColor() );
    FLinearColor bgColor = FLinearColor( FOdysseyVectorHUD::GetBackgroundColor() );
    FLinearColor hcColor = FLinearColor( FOdysseyVectorHUD::GetHighlightColor() );
...
void
FOdysseyPainterEditorVectorTransformToolHUD::DrawHUD( const FOdysseyHUDElement::FDrawHUDParams& iParams )
{

...
UOdysseyPainterEditorVectorPathPushTool::UOdysseyPainterEditorVectorPathPushTool()
    : UOdysseyPainterEditorVectorBaseTool( MakeShared<FOdysseyPainterEditorVectorPathPushToolHUD>( this ), false, true )
    , Radius( 20.0f )
...
bool
UOdysseyPainterEditorVectorPathPushTool::HasRadius() const
{
    return true;
}

void
UOdysseyPainterEditorVectorPathPushTool::SetRadius(float iRadius)
{
    Radius = iRadius;
}

float
UOdysseyPainterEditorVectorPathPushTool::GetRadius() const
{
    return Radius;
}
...
void
UOdysseyPainterEditorVectorPathPushTool::ExtendToolbar( UToolMenu* iToolMenu )
{

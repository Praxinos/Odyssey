...
#include "OdysseyToolCollectionFactory.generated.h"

UCLASS()
class ODYSSEYPAINTEREDITOR_API UOdysseyToolCollectionFactory
    : public UFactory
{
    GENERATED_BODY()

public:
    UOdysseyToolCollectionFactory(const FObjectInitializer& ObjectInitializer);

...
public class OdysseyFile : ModuleRules
{
    public OdysseyFile(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        */
        ...
        {
            throw new InvalidOperationException("ERROR in OdysseyFile Module : Target.Type == TargetType.Game");
        }

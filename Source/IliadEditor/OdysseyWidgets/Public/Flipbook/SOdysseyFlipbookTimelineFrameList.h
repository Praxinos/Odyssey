...
class ODYSSEYWIDGETS_API FOdysseyFlipbookTimelineFrameListFrameMetaData : public ISlateMetaData
{
public:
    SLATE_METADATA_TYPE(FOdysseyFlipbookTimelineFrameListFrameMetaData, ISlateMetaData)

public:
    FOdysseyFlipbookTimelineFrameListFrameMetaData(int32 iIndex);
...
class ODYSSEYWIDGETS_API SOdysseyFlipbookTimelineFrameList : public SCompoundWidget
{

public:
    SLATE_BEGIN_ARGS(SOdysseyFlipbookTimelineFrameList)
        {}
...
public:
    ...
    // TSharedPtr<SOdysseyFlipbookTimelineFrame>& GetFrame(int32 iIndex);
    // TSharedPtr<FOdysseyFlipbookTimelineFrame> GetFrameAt(int32 iIndex) const;
...
public:
    ...
    // void InsertFrameAt(TSharedPtr<SOdysseyFlipbookTimelineFrame>& iFrame, int32 iINdex);
    //void MoveFrame(int32 iSrcIndex, int32 iDstIndex);

private:
    // Private Event Handlers
    void OnLengthHandleDragStarted(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnLengthHandleDragged(int32 iOffset, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnLengthHandleDragStopped(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnTimingHandleDragStarted(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnTimingHandleDragged(int32 iOffset, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnTimingHandleDragStopped(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    FReply OnFrameDrop( const FGeometry& iGeometry, const FDragDropEvent& iDragDropEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnFrameDragEnter( const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    FReply OnFrameDragOver( const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    void OnFrameDragLeave( const FDragDropEvent& DragDropEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    FReply OnFrameDragDetected( const FGeometry& iGeometry, const FPointerEvent& iMouseEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);
    FReply OnGenerateFrameContextMenu( const FGeometry& iGeometry, const FPointerEvent& iMouseEvent, TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData);

private:
    // Private Utilities
    TSharedPtr<SWidget> CreateFrameControlWidget(TSharedPtr<SOdysseyFlipbookTimelineFrame>& iFrame);

    EVisibility DropPreviewLeftVisibility(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData) const;
    EVisibility DropPreviewRightVisibility(TSharedPtr<FOdysseyFlipbookTimelineFrameListFrameMetaData> iMetaData) const;
...
private:
    ...
    //Internal
    TArray<TSharedPtr<SOdysseyFlipbookTimelineFrame>> mFrames;

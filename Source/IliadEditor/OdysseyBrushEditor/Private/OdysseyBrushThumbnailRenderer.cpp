...
UOdysseyBrushThumbnailRenderer::DrawDefaultThumbnail( int32 X, int32 Y, uint32 Width, uint32 Height, FCanvas* Canvas )
{
    ...
    UTexture* defaultTexture = LoadObject< UTexture >( nullptr, TEXT( "/Odyssey/BrushThumbnails/OdysseyBrushDefaultThumbnail_512.OdysseyBrushDefaultThumbnail_512" ), nullptr, LOAD_None, nullptr );

        ...
        for (ULONG i = 0; i < PropertyCount; ++i)
        {
            ...
            switch (PacketDescription.Type)
            {
                ...
                case EInkPacketType::YTilt:
                    ...
                    break;
                // No more used, they are regenerated by tilt
                //case EInkPacketType::Azimuth:
                //    ink_state.Azimuth = Normalized * 360.f;
                //    break;
                //case EInkPacketType::Altitude:
                //    ink_state.Altitude = Normalized * 90.f; //WARNING: the azimuth inside FStylusState must be [0,1], so *90.f should be removed
                //    break;

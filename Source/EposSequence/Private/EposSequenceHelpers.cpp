...
EposSequenceHelpers::GetRootEposSequence( IMovieScenePlayer& iPlayer, const UEposMovieSceneSequence* iSequence )
{
    if( !iSequence )
        return nullptr;
    ...
    return GetRootEposSequence( iPlayer, sequence_ids[0] );
}

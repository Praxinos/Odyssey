...
namespace OdysseySeamsPaintRendering
{
    ...
    IMPLEMENT_SHADER_TYPE(, TOdysseySeamsPaintVertexShader, TEXT("/OdysseyShaders/Private/OdysseySeamsPaintShader.usf"), TEXT("MainVS"), SF_Vertex);
    ...
    IMPLEMENT_SHADER_TYPE(, TOdysseySeamsPaintPixelShader, TEXT("/OdysseyShaders/Private/OdysseySeamsPaintShader.usf"), TEXT("MainPS"), SF_Pixel);

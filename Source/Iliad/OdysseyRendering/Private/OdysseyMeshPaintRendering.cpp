...
namespace OdysseyMeshPaintRendering
{
    ...
    class ODYSSEYRENDERING_API TOdysseyMeshPaintVertexShader : public FGlobalShader
    {
    ...
    IMPLEMENT_SHADER_TYPE(, TOdysseyMeshPaintVertexShader, TEXT("/OdysseyShaders/Private/OdysseyMeshPaintShader.usf"), TEXT("MainVS"), SF_Vertex);


    /** Mesh paint pixel shader */
    class ODYSSEYRENDERING_API TOdysseyMeshPaintPixelShader : public FGlobalShader
    {
    ...
    IMPLEMENT_SHADER_TYPE(, TOdysseyMeshPaintPixelShader, TEXT("/OdysseyShaders/Private/OdysseyMeshPaintShader.usf"), TEXT("MainPS"), SF_Pixel);
    ...
    {
        TShaderMapRef< TOdysseyMeshPaintVertexShader > VertexShader(GetGlobalShaderMap(InShaderPlatform));
        TShaderMapRef< TOdysseyMeshPaintPixelShader > PixelShader(GetGlobalShaderMap(InShaderPlatform));

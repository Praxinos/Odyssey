...
// LayerStack Shortcuts Category
    ...
    UI_BUNDLE_COMMAND( ActivateTimelineCutAndClearTool, TimelineShortcuts, "Activate Timeline Cut & Clear Tool", "Activates the timeline Cut & Clear Tool", EUserInterfaceActionType::Button, FInputChord());
    ...
    UI_BUNDLE_COMMAND( HoldActivateTimelineCutAndClearTool, TimelineShortcuts, "Activate Timeline Cut & Clear Tool (Hold)", "Hold the key to activate the timeline Cut & Clear Tool temporarily", EUserInterfaceActionType::Button, FInputChord());

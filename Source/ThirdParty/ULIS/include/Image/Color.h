...
public:
    ...
    static FColor FromRGB( uint8 iR, uint8 iG, uint8 iB, uint8 iA = UINT8_MAX );

    /*! Static maker, build a color from G8 values, the color will have format eFormat::Format_GA8 */
    static FColor FromGrey8( uint8 iGrey );
    ...
    static FColor FromGreyAF( ufloat iGrey, ufloat iA = 1.f );
    ...
    static FColor FromRGBAF( ufloat iR, ufloat iG, ufloat iB, ufloat iA = 1.f );
    ...
    static FColor FromHSVAF( ufloat iH, ufloat iS, ufloat iV, ufloat iA = 1.f );
    ...
    static FColor FromHSLAF( ufloat iH, ufloat iS, ufloat iL, ufloat iA = 1.f );
    ...
    static FColor FromCMYAF( ufloat iC, ufloat iM, ufloat iY, ufloat iA = 1.f );
    ...
    static FColor FromCMYKAF( ufloat iC, ufloat iM, ufloat iY, ufloat iK, ufloat iA = 1.f );
    ...
    static FColor FromYUVAF( ufloat iY, ufloat iU, ufloat iV, ufloat iA = 1.f );
    ...
    static FColor FromLabAF( ufloat iL, ufloat ia, ufloat ib, ufloat iA = 1.f );
    ...
    static FColor FromXYZAF( ufloat iX, ufloat iY, ufloat iZ, ufloat iA = 1.f );
    ...
    static FColor FromYxyAF( ufloat iY, ufloat ix, ufloat iy, ufloat iA = 1.f );

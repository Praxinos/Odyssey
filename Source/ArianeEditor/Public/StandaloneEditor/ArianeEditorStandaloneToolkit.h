...
class FArianeEditorStandaloneToolkit
    : public FAssetEditorToolkit
{
public:
    // Construction / Destruction
    virtual ~FArianeEditorStandaloneToolkit();
    FArianeEditorStandaloneToolkit(UObject* iEditedObject);
...
private:
    ...
    //TSharedPtr<FArianeEditor> mEditor;
};

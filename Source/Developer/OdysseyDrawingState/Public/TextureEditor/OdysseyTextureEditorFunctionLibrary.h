...
public:
    //Creates and Odyssey Block Proxy with current layer.
    ...
    //Creates and Odyssey Block Proxy with a layer to be identified with its name (to be entered in a string).
    //X | Y input are an offset.
    UFUNCTION( BlueprintPure, Category = "OdysseyTextureEditorFunctionLibrary", meta = (DefaultToSelf="BrushContext") )
    ...
    //Creates and Odyssey Block Proxy with a layer to be identified with an index, depending on the layer position in the layer stack (1 = top layer).
    //X | Y input are an offset.
    UFUNCTION( BlueprintPure, Category = "OdysseyTextureEditorFunctionLibrary", meta = (DefaultToSelf="BrushContext") )

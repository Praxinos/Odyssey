 ...
 */
class FLevelVisibilityTrackEditorOriginal
...
public:
	 ...
	 */
    FLevelVisibilityTrackEditorOriginal( TSharedRef<ISequencer> InSequencer );

	/** Virtual destructor. */
	virtual ~FLevelVisibilityTrackEditorOriginal() { }

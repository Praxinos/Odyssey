 ...
 */
class FLevelVisibilitySectionOriginal
	: public ISequencerSection
	, public TSharedFromThis<FLevelVisibilitySectionOriginal>
{
public:

    FLevelVisibilitySectionOriginal( UMovieSceneLevelVisibilitySection& InSectionObject );

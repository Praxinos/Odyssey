 ...
 */
class EPOSTRACKSEDITOR_API FAudioTrackEditorOriginal
...
public:
	 ...
	 */
    FAudioTrackEditorOriginal(TSharedRef<ISequencer> InSequencer);

	/** Virtual destructor. */
	virtual ~FAudioTrackEditorOriginal();
 ...
 */
class FAudioSectionOriginal
	: public ISequencerSection
	, public TSharedFromThis<FAudioSectionOriginal>
{
public:

	/** Constructor. */
    FAudioSectionOriginal(UMovieSceneSection& InSection, TWeakPtr<ISequencer> InSequencer);

	/** Virtual destructor. */
	virtual ~FAudioSectionOriginal();

...
void UEposSequenceEditorSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
    ...
    //CommandList->MapAction(FEposSequenceEditorCommands::Get().SnapSectionsToTimelineUsingSourceTimecode,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::SnapSectionsToTimelineUsingSourceTimecodeInternal),
    //    FCanExecuteAction::CreateLambda(AreMovieSceneSectionsSelected)
    //);

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().SyncSectionsUsingSourceTimecode,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::SyncSectionsUsingSourceTimecodeInternal),
    //    FCanExecuteAction::CreateLambda(AreMovieSceneSectionsSelected, 2)
    //);

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().BakeTransform,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::BakeTransformInternal)
    //);
    ...
    //CommandList->MapAction(FEposSequenceEditorCommands::Get().AddActorsToBinding,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::AddActorsToBindingInternal),
    //    FCanExecuteAction::CreateLambda(AreActorsSelected));

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().ReplaceBindingWithActors,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::ReplaceBindingWithActorsInternal),
    //    FCanExecuteAction::CreateLambda(AreActorsSelected));

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().RemoveActorsFromBinding,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::RemoveActorsFromBindingInternal),
    //    FCanExecuteAction::CreateLambda(AreActorsSelected));

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().RemoveAllBindings,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::RemoveAllBindingsInternal));

    //CommandList->MapAction(FEposSequenceEditorCommands::Get().RemoveInvalidBindings,
    //    FExecuteAction::CreateUObject(this, &UEposSequenceEditorSubsystem::RemoveInvalidBindingsInternal));
...
//
//USequencerModuleScriptingLayer* UEposSequenceEditorSubsystem::GetScriptingLayer()
//{
...
//}
//
//USequencerCurveEditorObject* UEposSequenceEditorSubsystem::GetCurveEditor()
//{
...
//}
//
//TArray<FMovieSceneBindingProxy> UEposSequenceEditorSubsystem::AddActors(const TArray<AActor*>& InActors)
//{
...
//}
//
//FMovieSceneBindingProxy UEposSequenceEditorSubsystem::CreateCamera(bool bSpawnable, ACineCameraActor*& OutActor)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//TArray<FMovieSceneBindingProxy> UEposSequenceEditorSubsystem::ConvertToSpawnable(const FMovieSceneBindingProxy& ObjectBinding)
//{
...
//}
//
//FMovieSceneBindingProxy UEposSequenceEditorSubsystem::ConvertToPossessable(const FMovieSceneBindingProxy& ObjectBinding)
//{
...
//}
//
//void UEposSequenceEditorSubsystem::SnapSectionsToTimelineUsingSourceTimecode(const TArray<UMovieSceneSection*>& Sections)
//{
//    const TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (!Sequencer)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::SyncSectionsUsingSourceTimecodeInternal()
//{
//    const TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (!Sequencer)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::SyncSectionsUsingSourceTimecode(const TArray<UMovieSceneSection*>& Sections)
//{
//    const TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (!Sequencer)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::BakeTransformInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::BakeTransform(const TArray<FMovieSceneBindingProxy>& ObjectBindings, const FFrameTime& BakeInTime, const FFrameTime& BakeOutTime, const FFrameTime& BakeInterval, const FMovieSceneScriptingParams& Params)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::CalculateFramesPerGuid(TSharedPtr<ISequencer>& Sequencer, const FBakingAnimationKeySettings& InSettings, TMap<FGuid, UEposSequenceEditorSubsystem::FBakeData>& OutBakeDataMap,
...
//}
//
//bool UEposSequenceEditorSubsystem::BakeTransformWithSettings(const TArray<FMovieSceneBindingProxy>& ObjectBindings, const FBakingAnimationKeySettings& InSettings, const FMovieSceneScriptingParams& Params)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
//        UE_LOG(LogEposSequenceEditor, Warning, TEXT("Bake Transform failed."));
//        return false;
//    }
//
//    UMovieScene* FocusedMovieScene = Sequencer->GetFocusedMovieSceneSequence()->GetMovieScene();
...
//
//void UEposSequenceEditorSubsystem::AddActorsToBindingInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::AddActorsToBinding(const TArray<AActor*>& Actors, const FMovieSceneBindingProxy& ObjectBinding)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::ReplaceBindingWithActorsInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::ReplaceBindingWithActors(const TArray<AActor*>& Actors, const FMovieSceneBindingProxy& ObjectBinding)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveActorsFromBindingInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveActorsFromBinding(const TArray<AActor*>& Actors, const FMovieSceneBindingProxy& ObjectBinding)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveAllBindingsInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveAllBindings(const FMovieSceneBindingProxy& ObjectBinding)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveInvalidBindingsInternal()
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RemoveInvalidBindings(const FMovieSceneBindingProxy& ObjectBinding)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::AddAssignActorMenu(FMenuBuilder& MenuBuilder)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//    }
//
//    MenuBuilder.AddMenuEntry(FEposSequenceEditorCommands::Get().AddActorsToBinding);
//    MenuBuilder.AddMenuEntry(FEposSequenceEditorCommands::Get().ReplaceBindingWithActors);
//    MenuBuilder.AddMenuEntry(FEposSequenceEditorCommands::Get().RemoveActorsFromBinding);
//    MenuBuilder.AddMenuEntry(FEposSequenceEditorCommands::Get().RemoveAllBindings);
//    MenuBuilder.AddMenuEntry(FEposSequenceEditorCommands::Get().RemoveInvalidBindings);
//
//    FMovieSceneBindingProxy BindingProxy(ObjectBindings[0], Sequencer->GetFocusedMovieSceneSequence());
//
...
//void UEposSequenceEditorSubsystem::GetRebindComponentNames(TArray<FName>& OutComponentNames)
//{
...
//}
//
//void UEposSequenceEditorSubsystem::RebindComponentMenu(FMenuBuilder& MenuBuilder)
//{
//    TArray<FName> ComponentNames;
//    GetRebindComponentNames(ComponentNames);
//
...
//}
//
//void UEposSequenceEditorSubsystem::RebindComponentInternal(const FName& ComponentName)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {
...
//}
//
//void UEposSequenceEditorSubsystem::RebindComponent(const TArray<FMovieSceneBindingProxy>& PossessableBindings, const FName& ComponentName)
//{
//    TSharedPtr<ISequencer> Sequencer = GetActiveSequencer();
//    if (Sequencer == nullptr)
//    {

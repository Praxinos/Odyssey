...
FImportImageSequenceImporter::FImportImageSequenceImporter( const FImportImageSequenceOptions& iOptions, FString& oErrorMessage )
{
    ...
    Build( iOptions.mPatternKeywords, oErrorMessage );
}
...
void
FImportImageSequenceImporter::Build( const TPatternKeywordList<EImportImageSequencePatternKeyword>& iPatternKeywordList, FString& oErrorMessage )
{
    ...
    pattern_map.Add( EImportImageSequencePatternKeyword::BoardId  , { iPatternKeywordList.mKeywordList[EImportImageSequencePatternKeyword::BoardId].mKeywordWithBraces , TEXT( "([_0-9a-zA-Z]+)" ) } );
    pattern_map.Add( EImportImageSequencePatternKeyword::ShotId   , { iPatternKeywordList.mKeywordList[EImportImageSequencePatternKeyword::ShotId].mKeywordWithBraces  , TEXT( "([_0-9a-zA-Z]+)" ) } );
    pattern_map.Add( EImportImageSequencePatternKeyword::PanelId  , { iPatternKeywordList.mKeywordList[EImportImageSequencePatternKeyword::PanelId].mKeywordWithBraces , TEXT( "([_0-9a-zA-Z]+)" ) } );
    pattern_map.Add( EImportImageSequencePatternKeyword::Duration , { iPatternKeywordList.mKeywordList[EImportImageSequencePatternKeyword::Duration].mKeywordWithBraces, TEXT( "([0-9]+)" ) } );
